...
import AgreementForm from "../InvestFund/AgreementForm";
...
const Botsubscription = () => {
  ...
  return (
    <>
      <div className="stake-card d-flex justify-content-center gap-3 p-3">
        <div style={{ position: "relative"}}> 
          ...
          />
          {loading && (
            <small style={{ position: "absolute", bottom: "-18px", left: "5px", color: "#e67e22", fontSize: "11px" }}>
              Checking database...
            </small>
          )}
          {!loading && hasChecked && isValidUser && (
            <small style={{ position: "absolute", bottom: "-18px", left: "5px", fontSize: "11px", color: isBotActive ? "#27ae60" : "#f39c12", fontWeight: "600", whiteSpace: "nowrap" }}>
              {isBotActive
          ...
          {!loading && hasChecked && !isValidUser && (
            <small style={{ position: "absolute", bottom: "-18px", left: "5px", color: "#e74c3c", fontSize: "11px", fontWeight: "bold", whiteSpace: "nowrap", background: "transparent" }}>
        ...
        <button
          ...
          disabled={loading}
          style={{
            backgroundColor: !isValidUser && hasChecked ? "#95a5a6" : isBotActive ? "green" : "#839490",
            color: "white",
            border: "none",
            padding: "10px 20px",
            borderRadius: "8px",
